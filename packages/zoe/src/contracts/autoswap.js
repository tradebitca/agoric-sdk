...
const start = async zcf => {
  ...
  const swapInHandler = swapSeat => {
    ...
    assert(
      !amountMath.isEmpty(getPoolAmount(brands.Central), brands.Central),
  ...
  const addLiquidityHandler = liqSeat => {
    ...
    if ((amountMath.isEmpty(getPoolAmount(brands.Central)), brands.Central)) {
    ...
    assert(
      amountMath.isGTE(secondaryIn, secondaryOut, brands.Secondary),
